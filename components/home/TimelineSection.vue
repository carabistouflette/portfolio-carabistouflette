  ...
  <section class="section-padding">
    <div class="container-custom">
      ...
      <div class="relative max-w-4xl mx-auto">
        ...
        <div ref="timelineLineRef" class="hidden md:block absolute left-1/2 transform -translate-x-1/2 top-0 bottom-0 w-0.5 bg-surface2 opacity-0 transition-all duration-700"></div>
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  class="bg-surface1 text-text px-6 py-3 rounded-full font-bold text-lg shadow-xl opacity-0 transition-all duration-700 border border-surface2"
                >
                  {{ item.year }}
                </div>
              </div>
